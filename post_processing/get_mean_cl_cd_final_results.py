...
def compute_mean_std_coefficients(cases: list, env: str = "rotatingCylinder2D", start: Union[int, float] = 8) -> None:
    controlled = []
    for c in cases:
    ...
    idx = [controlled[c][controlled[c]["t"] == start].index.values.item() for c in range(len(controlled))]
...
if __name__ == "__main__":
    cases_cylinder = ["e200_r10_b10_f8_MF", "e200_r10_b10_f8_MB_1model", "e200_r10_b10_f8_MB_5models_thr3",
                      "e200_r10_b10_f8_MB_5models_thr2", "e200_r10_b10_f8_MB_10models_thr6",
                      "e200_r10_b10_f8_MB_10models_thr5", "e200_r10_b10_f8_MB_10models_thr3"]

    cases_pinball = ["e150_r10_b10_f300_MF", "e150_r10_b10_f300_MB_1model", "e150_r10_b10_f300_MB_5models_thr2",
    ...
    compute_mean_std_coefficients(cases_pinball, env="rotatingPinball2D", start=350)
